...
This crate provides the command-line interface (CLI) for interacting with the AIngle framework, enabling users to manage applications, agents, and data from the terminal.