...
This crate defines the fundamental data types and common structures used across the entire AIngle framework, ensuring type safety and consistency for all components.