//! WASM boundary types for semantic graph and memory operations.
//!
//! These types define the interface between zome code and the Cortex
//! knowledge layer. They were previously part of `aingle_zome_types`
//! but are now self-contained to avoid pulling in legacy dependencies.
