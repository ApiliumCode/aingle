...
This crate provides direct peer-to-peer communication mechanisms for the Kitsune P2P network, enabling direct connections between nodes without intermediaries.
