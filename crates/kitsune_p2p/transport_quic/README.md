...
# Kitsune P2P Transport QUIC

This crate provides a QUIC-based transport layer for the Kitsune P2P network, ensuring secure, reliable, and efficient communication between peers.