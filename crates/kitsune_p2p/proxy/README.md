...
This crate provides proxy functionalities for the Kitsune P2P network, allowing nodes to communicate indirectly through proxy servers, enhancing connectivity and NAT traversal.