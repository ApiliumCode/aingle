...
This crate provides mDNS (multicast DNS) discovery functionalities for the Kitsune P2P network, allowing local peer discovery in a zero-configuration manner.