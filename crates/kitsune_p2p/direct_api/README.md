...
# Kitsune P2P Direct API

This crate defines the API for direct communication within the Kitsune P2P network, providing interfaces for establishing and managing direct peer connections.
