...
This crate provides WebSocket communication functionalities for the AIngle project. It handles real-time data exchange and integration with the AIngle network.