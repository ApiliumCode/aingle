...
macro_rules! entry_def_index {
    ( $t:ty ) => {
        // Note: We call entry_defs(()) without $crate:: prefix because the function
        // is generated in the user's crate by the entry_defs! macro, not in adk.
        // Using $crate::entry_defs would find the macro instead of the function.
        match entry_defs(()) {
