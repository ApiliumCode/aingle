...
///
/// AIngle 2.0: Made configurable via AINGLE_PUBLISH_INTERVAL_MS env var.
/// Set to 0 for sub-second confirmation (IoT mode).
/// Default: 5000ms (5 seconds) for backwards compatibility.
pub fn min_publish_interval() -> time::Duration {
    std::env::var("AINGLE_PUBLISH_INTERVAL_MS")
        .ok()
...
/// Legacy constant - use min_publish_interval() for configurable version
#[deprecated(since = "2.0.0", note = "Use min_publish_interval() instead")]
