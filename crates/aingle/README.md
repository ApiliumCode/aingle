...
This crate is the main conductor and runtime for the AIngle framework, orchestrating the various components and providing the core execution environment for distributed intelligent applications.