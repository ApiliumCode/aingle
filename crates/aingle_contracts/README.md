...
This crate defines the smart contract interface and runtime environment for the AIngle framework, allowing developers to deploy and execute secure, distributed business logic.