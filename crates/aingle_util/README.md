...
This crate provides common utility functions and helper macros used across various components of the AIngle framework, promoting code reuse and consistency.