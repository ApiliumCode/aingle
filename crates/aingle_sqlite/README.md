...
This crate provides SQLite database integration for the AIngle framework, offering a robust and embedded solution for persistent data storage and management.