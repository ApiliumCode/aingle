...
- [Call zome functions from your test](https://github.com/ApiliumCode/aingle/blob/develop/crates/aingle/src/core/ribosome/host_fn/commit_entry.rs#L234)
- [Boot up the conductor and call zome functions](https://github.com/ApiliumCode/aingle/blob/develop/crates/aingle/tests/ser_regression.rs)
